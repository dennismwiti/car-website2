        ...
        if(windowWidth > 0) {
            if ($(document).scrollTop() >= 100) {
                ...
                if($('.do-sticky').length < 1) {
                    $('.company-logo img').attr('src', '/static/img/logos/newlogo-removebg-preview.png');
                }
            }
            else {
            ...
            $('.company-logo img').attr('src', '/carseller/static/img/logos/newlogo-removebg-preview.png');
        }
    }
